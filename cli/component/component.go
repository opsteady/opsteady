...
// Initialize is an interface used to
type Initialize interface {
	Initialize(DefaultComponent)
}

// DefaultComponent implements the Component interface in a general way
// This implementation should suite all the components but if not they
// can adjust it the way they want or even override the whole functions
// The implemented functions stop (Fatal) if there is an error detected
