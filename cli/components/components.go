...
import (
	...
	capabilitiesMonitoring "github.com/opsteady/opsteady/capabilities/monitoring/cicd"
...
func init() {
	...
	Components["capabilities-monitoring"] = &capabilitiesMonitoring.CapabilititiesMonitoring{}
