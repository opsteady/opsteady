...
func (k *KubernetesAzurePodIdentity) Initialize(defaultComponent component.DefaultComponent) {
	...
	k.DefaultComponent.UseHelm(component.NewHelmChart(
		"aad-pod-identity",
		"4.1.7", // renovate: datasource=helm registryUrl=https://raw.githubusercontent.com/Azure/aad-pod-identity/master/charts depName=aad-pod-identity versioning=semver
	))
}
